import { getGlobalSpeciesAdapters, _ALL_TOOLS, _ARTISAN_TOOLS, _MUSICAL_INSTRUMENTS, _STD_LANGS, _ALL_LANGS, _EXOTIC_LANGS } from '../registry.js';
...
export function getGenericSpeciesChoiceSpecs(species) {
...
function _runGlobalSpeciesAdapters(species, ctx) {
  var list = getGlobalSpeciesAdapters();
...
export function adaptSpeciesRecord(rawSpecies, ctx) {
  return _runGlobalSpeciesAdapters(_speciesNormalizeRecord(rawSpecies, ctx), ctx);
}

export function adaptSpeciesDataset(rawSpecies, ctx) {
...
if (_glob) {
  _glob.getGenericSpeciesChoiceSpecs = getGenericSpeciesChoiceSpecs;
  _glob.adaptSpeciesRecord  = adaptSpeciesRecord;
  _glob.adaptSpeciesDataset = adaptSpeciesDataset;
}
