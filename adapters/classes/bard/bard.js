registerClassAdapter("Bard", function (cls, lv, specs) {
  if (lv >= 1) {
    ...
    specs.push({ key: 'bard_instrument_2', label: 'Musical Instrument 2 (Bard)', type: 'generic_choice', from: window._MUSICAL_INSTRUMENTS || [], count: 1, level: 1 });
    specs.push({ key: 'bard_instrument_3', label: 'Musical Instrument 3 (Bard)', type: 'generic_choice', from: window._MUSICAL_INSTRUMENTS || [], count: 1, level: 1 });
  }
  if (lv >= 2) {
