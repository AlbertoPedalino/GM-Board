...
const { createSectionInstance, makeSectionInstanceId } = await import('../../../src/shared/sectionInstances.js');
const { SECTION_KEYS, SECTION_REGISTRY } = await import('../../../src/shared/sectionRegistry.js');
