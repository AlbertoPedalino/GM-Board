...
} from '../../../../src/shared/cloud/cloudAutoSyncEngine.js';
import { SECTION_REGISTRY } from '../../../../src/shared/sectionRegistry.js';
...
test('entry autosync keeps section storage adapters behind a dynamic import', () => {
  const source = readFileSync(new URL('../../../../src/shared/cloud/CloudAutoSync.jsx', import.meta.url), 'utf8');
