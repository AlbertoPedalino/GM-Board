...
import { THROWN_DIE_SIZE, thrownDieSize } from '../../../../../src/shared/vtt/dicePhysics.js';
import DiceTray, { RESULT_REVEAL_HOLD_MS } from '../../../../../src/pages/vtt/components/DiceTray.jsx';

const mocks = vi.hoisted(() => ({ simulateThrow: vi.fn() }));

vi.mock('../../../../../src/shared/vtt/dicePhysics.js', async (importOriginal) => ({
