...
import SceneEditor from '../../../../../src/pages/vtt/components/SceneEditor.jsx';
...
vi.mock('../../../../../src/shared/vtt/useSceneLive.js', () => ({
  useSceneLive: () => ({
    sendCamera: vi.fn(),
    sendDrag: vi.fn(),
...
vi.mock('../../../../../src/pages/encounterbuilder/hooks/useConditionEntries.js', () => ({
  useConditionEntries: () => [],
}));
vi.mock('../../../../../src/pages/vtt/hooks/useEncounterBridge.js', () => ({
  useEncounterBridge: () => ({ pull: vi.fn(), push: vi.fn() }),
}));
vi.mock('../../../../../src/pages/vtt/hooks/useSceneDungeon.js', () => ({
  useSceneDungeon: () => ({ fights: [], monstersForRoom: () => [], markersForRoom: () => [] }),
}));
vi.mock('../../../../../src/pages/vtt/hooks/useSceneHexcrawl.js', () => ({
  useSceneHexcrawl: () => ({
    visible: true,
    cellsByKey: new Map([
...
vi.mock('../../../../../src/pages/vtt/hooks/useVttRolls.js', () => ({
  useVttRolls: () => ({
    clearFeed: vi.fn(),
    diceThrows: [],
    dismissToast: vi.fn(),
...
vi.mock('../../../../../src/pages/vtt/hooks/useSceneContent.js', () => ({
  useSceneContent: () => ({
    drawings: [
...
vi.mock('../../../../../src/pages/vtt/components/SceneViewport.jsx', () => ({
  default: (props) => {
