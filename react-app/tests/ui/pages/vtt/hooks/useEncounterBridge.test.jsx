...
import { useEncounterBridge } from '../../../../../src/pages/vtt/hooks/useEncounterBridge.js';
...
vi.mock('../../../../../src/pages/encounterbuilder/logic/storage.js', () => ({
  persistFights: vi.fn(),
  readPersistedInstance: storage.readPersistedInstance,
  readRegistry: () => [],
}));
vi.mock('../../../../../src/pages/encounterbuilder/logic/combat.js', () => ({
