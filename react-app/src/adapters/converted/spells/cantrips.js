 ...
 *   die      â€” dado base danno (es. '1d8'). Scalato automaticamente x lv 5/11/17.
 *   dmgType  â€” tipo danno (stringa) o '' per utility
 *   range    â€” portata (stringa)
 *   toHit    â€” true = tiro per colpire (ATK); false = no
 *   hasSave  â€” true = tiro salvezza richiesto (SAV); false = no
 *   notes    â€” testo note extra (opzionale)
 *
...
(function () {
  ...
  /* â”€â”€ Damaging â€” attack roll â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  registerCantripData("Ray of Frost", {
    ...
    range: "60 ft",
    toHit: true, hasSave: false,
    notes: "Speed âˆ’10 ft to target"
  });
  ...
  registerCantripData("True Strike", {
    ...
    range: "5 ft",
    toHit: true, hasSave: false,
    notes: "Use action â€” then weapon attack as bonus action"
  });

  /* â”€â”€ Damaging â€” saving throw â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  registerCantripData("Sacred Flame", {
    icon: "sparkles",
    die: "1d8", dmgType: "radiant",
    range: "60 ft",
    toHit: false, hasSave: true,
    notes: "DEX save negates â€” no benefit from cover"
  });
  ...
  registerCantripData("Vicious Mockery", {
    ...
    range: "60 ft",
    toHit: false, hasSave: true,
    notes: "WIS save â€” disadvantage on next attack"
  });
  registerCantripData("Acid Splash", {
    ...
    range: "60 ft",
    toHit: false, hasSave: true,
    notes: "DEX save â€” can hit 2 adjacent targets"
  });
  registerCantripData("Thunderclap", {
    ...
    range: "5 ft",
    toHit: false, hasSave: true,
    notes: "CON save â€” audible 100 ft away"
  });

  /* â”€â”€ Utility â€” no attack, no save â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  registerCantripData("Word of Radiance", {
    ...
    range: "5 ft",
    toHit: false, hasSave: true,
    notes: "CON save â€” each creature of your choice within range"
  });
  registerCantripData("Infestation", {
    ...
    range: "30 ft",
    toHit: false, hasSave: true,
    notes: "CON save â€” target moves 5 ft in random direction on fail"
  });
  registerCantripData("Create Bonfire", {
    ...
    range: "60 ft",
    toHit: false, hasSave: true,
    notes: "DEX save â€” bonfire lasts 1 min, concentration. Entering it re-triggers save."
  });
  registerCantripData("Frostbite", {
    ...
    range: "60 ft",
    toHit: false, hasSave: true,
    notes: "CON save â€” disadvantage on next weapon attack on fail"
  });
  registerCantripData("Lightning Lure", {
    ...
    range: "15 ft",
    toHit: false, hasSave: true,
    notes: "STR save â€” pull target up to 10 ft toward you"
  });
})();
