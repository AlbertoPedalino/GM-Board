...
registerSubclassSheetActions("Fighter_Champion", [
  { name: "Improved Critical", icon: "", cat: "attack", uses: "Passive", minLevel: 3,
    desc: "Your weapon attacks and Unarmed Strikes score a Critical Hit on a roll of 19 or 20. At level 15 (Superior Critical), the range becomes 18â€“20." },
  ...
  { name: "Survivor", icon: "", cat: "action", uses: "Passive", minLevel: 18,
    desc: "Two benefits â€” Defy Death: Advantage on Death Saving Throws; rolling 18â€“20 on a Death Save counts as rolling a 20. Heroic Rally: at the start of each of your turns, regain HP equal to 5 + your CON modifier if you are Bloodied and have at least 1 HP." },
]);
// [SheetRuntime] END
