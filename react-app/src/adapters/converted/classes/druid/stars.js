...
registerSubclassSheetActions("Druid_Stars", [
  ...
  },
  {
    ...
    "resKey": "wild_shape",
    "minLevel": 3,
    "desc": "Spend a Wild Shape use to take on a starry form for 10 minutes (retain your stats; body becomes luminous, sheds Bright Light 10 ft and Dim Light 10 ft beyond). Choose one constellation: Archer â€” when you activate this form and as a Bonus Action on subsequent turns, make a ranged spell attack (60 ft, 1d8+WIS Radiant on hit; 2d8+WIS at lv.10). Chalice â€” when you cast a spell using a spell slot that restores HP to a creature, you or another creature within 30 ft also regains 1d8+WIS HP (2d8+WIS at lv.10). Dragon â€” when you make an INT or WIS check or a CON save to maintain Concentration, treat a d20 roll of 9 or lower as a 10. At lv.10, you can change constellation at the start of each of your turns."
  },
  {
    "name": "Cosmic Omen",
    "icon": "",
    ...
    "minLevel": 6,
    "desc": "After each Long Rest, consult your Star Map and roll any die. Even = Weal, Odd = Woe. Uses: WIS modifier (min 1) per Long Rest. Reaction when a creature you can see within 30 ft is about to make a D20 Test: Weal â€” roll 1d6 and add the number to the roll. Woe â€” roll 1d6 and subtract the number from the roll."
  },
  {
