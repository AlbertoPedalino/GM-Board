...
registerClassAdapter("Rogue", function (cls, lv, specs) {
  if (lv >= 1) {
    // Expertise (L1): 2 slot; uno puÃ² essere Thieves' Tools
...
registerClassSheetActions("Rogue", [
  ...
  },
  {
    ...
    "uses": "Sneak Attack dice",
    "minLevel": 14,
    "desc": "Additional Cunning Strike options: Daze (2 dice, CON save or Incapacitated until end of your next turn), Knock Out (6 dice, CON save or Unconscious for 1 min â€” ends if target takes damage or is shaken), Obscure (3 dice, DEX save or Blinded until end of your next turn)."
  },
  {
    "name": "Evasion",
    "icon": "",
