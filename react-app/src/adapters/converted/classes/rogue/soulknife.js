...
registerSubclassSheetActions("Rogue_Soulknife", [
  ...
  },
  {
    ...
    "resKey": "psionic_dice",
    "minLevel": 9,
    "desc": "Bonus Action: manifest a Psychic Blade, expend one Psionic Energy Die and roll it, then throw the blade to an unoccupied space you can see up to (10 Ã— roll) feet away. You then teleport to that space, and the blade vanishes."
  },
  {
    "name": "Psychic Veil",
    "icon": "",
