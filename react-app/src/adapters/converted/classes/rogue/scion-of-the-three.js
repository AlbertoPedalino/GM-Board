...
registerSubclassSheetActions("Rogue_Scion of the Three", [
  ...
  },
  {
    ...
    "minLevel": 3,
    "desc": "Reaction â€” when an enemy creature within 30 ft becomes Bloodied (reaches half its Hit Point maximum or fewer): teleport to an unoccupied space within 5 ft of that creature and immediately make one melee weapon attack against it. Uses: INT modifier (min 1) per Long Rest."
  },
  {
    "name": "Strike Fear",
    "icon": "",
    ...
    "minLevel": 9,
    "desc": "Cunning Strike option â€” Terrify (costs 1d6 from Sneak Attack dice): the target must succeed on a WIS saving throw (DC = 8 + PB + INT modifier) or become Frightened of you for 1 minute. While Frightened this way, you have Advantage on attack rolls against it. The creature repeats the save at the end of each of its turns, ending the effect on a success."
  },
  {
