...
registerSubclassSheetActions("Artificer_Cartographer", [
  ...
  },
  {
    ...
    "minLevel": 15,
    "desc": "Safe Haven: when a map holder would drop to 0 HP but not be killed outright, that creature can destroy its map â€” its HP instead change to twice your Artificer level, and it teleports to within 5 ft of you or another map holder of its choice. Unerring Path: if you are one of the map holders, cast Find the Path without a spell slot, without preparing it, and without spell components. 1/LR."
  }
]);
