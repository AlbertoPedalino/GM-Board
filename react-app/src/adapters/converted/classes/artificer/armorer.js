...
registerSubclassSheetActions("Artificer_Armorer", [
  ...
  },
  {
    ...
    "choiceKey": "armorer_model",
    "model": "Dreadnaught",
    "desc": "Dreadnaught model. Bonus Action: enlarge armor for 1 minute â€” reach +5 ft, and if smaller than Large you become Large (if space permits). Uses: INT modifier (min 1) per Long Rest."
  },
  {
    "name": "Extra Attack",
    "icon": "",
  ...
  },
  {
    ...
    "choiceKey": "armorer_model",
    "model": "Infiltrator",
    "desc": "Lightning Launcher damage increases to 2d6. Creatures that take Lightning damage from it glimmer until your next turn: shed Dim Light 5 ft, have Disadvantage on attacks against you. Bonus Action: gain Fly Speed = 2Ã— your Speed until end of turn. Uses: INT modifier (min 1) per Long Rest."
  },
  {
...
registerSubclassSheetEffects("Artificer_Armorer", [
  // Infiltrator model â€” gated on Arcane Armor flag + model choice
