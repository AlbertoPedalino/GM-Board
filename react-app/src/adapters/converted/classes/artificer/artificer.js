...
registerClassSheetActions("Artificer", [
  ...
  },
  {
    ...
    "minLevel": 20,
    "desc": "Passive: you gain +1 bonus to all saving throws per magic item you are currently attuned to (max +6). Reaction: when you are reduced to 0 HP, you can end one of your attunements â€” you drop to 1 HP instead."
  }
]);
...
// â”€â”€ Choice key filter: which char.choices keys belong to Artificer â”€â”€
...
// â”€â”€ Choice label provider: human-readable label for each Artificer choice key â”€â”€
