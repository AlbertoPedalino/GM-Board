...
registerSubclassSheetActions("Monk_Open Hand", [
  ...
  { name: "Quivering Palm", icon: "", cat: "attack", uses: "4 Focus Points", resKey: "ki", minLevel: 17,
    ...
    damageKind: "damage",
    desc: "When you hit a creature with an Unarmed Strike, expend 4 Focus Points to set up lethal vibrations lasting a number of days equal to your Monk level. You can end them (no action required, harmlessly) or as an Action, or by forgoing one attack of your Attack action â€” target must be on the same plane. Target makes a CON save (spell save DC): fail = 10d12 Force damage; success = half. Only one creature at a time." },
]);
