...
registerSubclassSheetActions("Ranger_Gloom Stalker", [
  ...
  },
  {
    ...
    "minLevel": 11,
    "desc": "Your Dread Ambusher Psychic damage increases to 2d8. In addition, when you deal that extra Psychic damage, you can cause one of these additional effects: Extra Strike â€” make another attack with the same weapon against a different creature within 5 ft of the original target and within weapon range; Mass Fear â€” the target and each creature within 10 ft of it must make a WIS saving throw (spell save DC) or have the Frightened condition until the start of your next turn."
  },
  {
    "name": "Shadowy Dodge",
    "icon": "",
