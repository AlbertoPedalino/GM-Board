...
registerSubclassSheetActions("Wizard_Illusionist", [
  ...
  { name: "Phantasmal Creatures", icon: "", cat: "action", uses: "2 / LR", resKey: "phantasmal_creatures", minLevel: 6,
    desc: "Summon Beast and Summon Fey are always prepared for you. Whenever you cast either spell, you can change its school to Illusion (the summoned creature appears spectral). Once per LR each, you can cast the Illusion version without expending a spell slot â€” the summoned creature has half its normal HP when cast this way." },
