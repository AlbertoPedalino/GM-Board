...
registerSubclassSheetActions("Wizard_Evoker", [
  ...
  { name: "Overchannel", icon: "", cat: "action", uses: "1st use free / LR", resKey: "overchannel", minLevel: 14,
    desc: "When you cast a Wizard spell with a spell slot of levels 1â€“5 that deals damage, you can deal maximum damage with that spell on the turn you cast it. First use per LR: no adverse effect. Each subsequent use before a LR: take Necrotic damage ignoring Resistance and Immunity â€” starts at 2d12 per spell level, then increases by 1d12 per spell level with each additional use (3rd use = 3d12/level, etc.)." },
]);
