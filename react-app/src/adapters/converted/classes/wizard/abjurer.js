...
registerSubclassSheetActions("Wizard_Abjurer", [
  { name: "Arcane Ward", icon: "", cat: "action", uses: "Ward HP", resKey: "arcane_ward", minLevel: 3,
    desc: "When you cast an Abjuration spell with a spell slot, you can simultaneously create an Arcane Ward that lasts until you finish a Long Rest. Ward max HP = 2 Ã— Wizard level + INT modifier. When you take damage, the ward takes it first (your Resistances/Vulnerabilities apply before reducing ward HP); if the ward reaches 0 HP, you take any remaining damage. Restore ward HP equal to 2 Ã— spell slot level whenever you cast an Abjuration spell with a slot. Alternatively, Bonus Action: expend a spell slot to restore 2 Ã— that slot's level to the ward. You can only create the ward once per Long Rest." },
