...
registerSubclassSheetActions("Wizard_Diviner", [
  { name: "Portent", icon: "", cat: "action", uses: "2â€“3 / LR", resKey: "portent", minLevel: 3,
  ...
  { name: "The Third Eye", icon: "", cat: "bonus", uses: "1 / SR+LR", resKey: "third_eye", minLevel: 10,
    desc: "Bonus Action: choose one benefit until you start a Short or Long Rest â€” Darkvision: gain Darkvision 120 ft; Greater Comprehension: read any language; See Invisibility: cast See Invisibility without expending a spell slot. Recharge: Short or Long Rest." },
]);
