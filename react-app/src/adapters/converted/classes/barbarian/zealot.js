...
registerSubclassSheetActions("Barbarian_Zealot", [
  ...
  { name: "Rage of the Gods", icon: "", cat: "action", uses: "1 / LR", resKey: "zealot_rage_gods", minLevel: 14,
    desc: "When you activate your Rage, assume a divine warrior form for 1 minute or until you drop to 0 HP (1/LR). Three benefits while in this form â€” Flight: Fly Speed equal to your Speed, can hover; Resistance: Resistance to Necrotic, Psychic, and Radiant damage; Revivification: Reaction when a creature within 30 ft would drop to 0 HP, expend a use of your Rage to change its HP to a number equal to your Barbarian level instead." },
]);
