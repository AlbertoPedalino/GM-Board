...
registerSubclassSheetActions("Barbarian_Wild Heart", [
  ...
  },
  {
    ...
    minLevel: 6,
    desc: "Choose a permanent trait (can change after each Long Rest) â€” Owl: Darkvision 60 ft (or +60 ft if already have it); Panther: Climb Speed = walking Speed; Salmon: Swim Speed = walking Speed."
  },
  {
    name: "Nature Speaker",
    icon: "",
