...
registerClassSheetActions("Paladin", [
  ...
  },
  {
    ...
    "desc": "Touch a creature to restore HP from your pool (1 HP per point spent), or spend 5 points to remove the Poisoned condition. Pool = 5 Ã— Paladin level. Recharge: Long Rest."
  },
  {
    ...
    "resKey": "paladin_channel_div",
    "minLevel": 3,
    "desc": "Subclass-specific option (see your Oath). Uses: 2 (lv.3â€“10), 3 (lv.11+). Recharge: Short Rest."
  },
  {
