...
registerSubclassSheetActions("Paladin_Devotion", [
  ...
  { name: "Holy Nimbus", icon: "", cat: "bonus", uses: "1 / LR or lv5 slot", resKey: "devotion_holy_nimbus", minLevel: 20,
    ...
    desc: "Bonus Action: imbue your Aura of Protection with holy power for 10 minutes (no action to end). Three benefits â€” Holy Ward: Advantage on saving throws forced by Fiends or Undead; Radiant Damage: enemies starting their turn in the aura take Radiant damage equal to your CHA modifier + Proficiency Bonus; Sunlight: the aura is filled with Bright Light that is sunlight. Recharge: LR, or expend a level 5 spell slot." },
]);
