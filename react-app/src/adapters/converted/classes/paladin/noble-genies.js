...
registerSubclassAdapter("Paladin_Noble Genies", function (cls, lv, specs) {
  if (lv >= 3) {
    specs.push({
      ...
      label: "Genie's Splendor â€” Skill Proficiency",
      type: 'skill_choice',
...
registerSubclassSheetActions("Paladin_Noble Genies", [
  ...
  },
  {
    ...
    "minLevel": 20,
    "desc": "Bonus Action: for 10 minutes (or until you use this feature again), assume the form of a Noble Genie. 1/LR, or expend a level 5+ spell slot. Benefits: Flight â€” you gain a Fly Speed of 60 ft with the Hover property. Minor Wish â€” when you or a creature within your Aura of Protection fails a D20 Test, you can use your Reaction to cause the roll to succeed instead."
  }
]);
