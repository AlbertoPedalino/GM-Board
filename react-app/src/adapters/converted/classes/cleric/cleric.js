  ...
  if (lv >= 1) {
    ...
    if (Array.isArray(_divOrder) ? _divOrder.includes('Thaumaturge') : _divOrder === 'Thaumaturge') {
      specs.push({
        ...
        label: 'Thaumaturge â€” Extra Cantrip',
        type: 'spell_choice',
...
registerClassSheetActions("Cleric", [
  {
    ...
    "cat": "action",
    "uses": "Passive",
    "desc": "Choose at lv.1 â€” Protector: proficiency with Martial weapons and Heavy armor; or Thaumaturge: learn one extra Cleric cantrip and gain a bonus equal to your WIS modifier (min +1) to Intelligence (Arcana or Religion) checks."
  },
  {
    ...
    "resKey": "channel_div",
    "minLevel": 2,
    "desc": "Channel your deity's power. Uses: 2 (lv.2â€“5), 3 (lv.6â€“17), 4 (lv.18+). Recharge: Short Rest. Options include Turn Undead and your Domain's feature (see subclass)."
  },
  {
    "name": "Turn Undead",
    "icon": "",
  ...
  },
  {
    ...
    "uses": "Passive",
    "minLevel": 14,
    "desc": "Your Blessed Strikes choice is upgraded â€” Divine Strike: extra damage increases to 2d8; Potent Spellcasting: when you deal damage with a Cleric cantrip, you also grant Temporary HP equal to twice your WIS modifier to yourself or one creature within 60 ft."
  },
  {
    ...
    "resKey": "divine_intervention",
    "minLevel": 20,
    "desc": "Your Divine Intervention can now target a Wish spell. If you cast Wish this way, you can't use Divine Intervention again until you finish 2d4 Long Rests. Otherwise functions as Divine Intervention (cast any Cleric spell â‰¤lv5, no slot or material component). Recharge: Long Rest."
  }
]);
