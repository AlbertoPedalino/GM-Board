...
registerSubclassSheetActions("Cleric_Trickery", [
  ...
  { name: "Channel: Invoke Duplicity", icon: "", cat: "bonus", uses: "1 Channel / 1 min", resKey: "channel_div",
    desc: "Bonus Action: expend one use of Channel Divinity to create a perfect visual illusion of yourself in an unoccupied space within 30 ft (not Concentration). Lasts 1 minute or until dismissed or Incapacitated. Benefits while active â€” Cast Spells: cast spells as if in the illusion's space (use your own senses); Distract: when both you and the illusion are within 5 ft of a creature that can see the illusion, you have Advantage on attack rolls against it; Move: Bonus Action to move the illusion up to 30 ft (within 120 ft of you)." },
  ...
  { name: "Improved Duplicity", icon: "", cat: "action", uses: "Passive", minLevel: 17,
    desc: "Your Invoke Duplicity illusion gains two upgrades â€” Shared Distraction: you and your allies have Advantage on attack rolls against any creature within 5 ft of the illusion; Healing Illusion: when the illusion ends, you or one creature of your choice within 5 ft of it regains HP equal to your Cleric level." },
]);
// [SheetRuntime] END
