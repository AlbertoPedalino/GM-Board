...
registerSubclassSheetActions("Cleric_Life", [
  ...
  { name: "Channel: Preserve Life", icon: "", cat: "action", uses: "1 Channel", resKey: "channel_div",
    ...
    desc: "Magic action: present your Holy Symbol and expend one use of Channel Divinity to restore HP equal to 5 Ã— your Cleric level. Choose Bloodied creatures within 30 ft of yourself (including you) and divide those HP among them. Cannot restore a creature beyond half its HP maximum." },
  ...
  { name: "Supreme Healing", icon: "", cat: "action", uses: "Passive", minLevel: 17,
    desc: "When you would roll dice to restore HP with a spell or Channel Divinity, don't roll â€” instead use the highest number possible for each die (e.g., d6 = 6, d8 = 8)." },
]);
// [SheetRuntime] END
