...
registerSubclassSheetActions("Bard_Valor", [
  { name: "Combat Inspiration", icon: "", cat: "reaction", uses: "With Bardic Insp.", minLevel: 3,
    desc: "A creature that has one of your Bardic Inspiration dice can use it for one of these effects: Shield â€” when hit by an attack roll, use its Reaction to roll the die and add the result to its AC against that attack (potentially causing a miss); Strike â€” immediately after hitting a target with an attack roll, roll the die and add the result to the attack's damage." },
