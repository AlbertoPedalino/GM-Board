...
registerClassSheetActions("Bard", [
  { name: "Bardic Inspiration", icon: "", cat: "bonus",  uses: "CHA mod / SR", resKey: "bardic_insp",
    ...
    rollLabelPrefix: "Bardic Inspiration",    desc: "Bonus Action: give one Bardic Inspiration die to a creature within 60 ft (not yourself). Die size: d6 (lv.1â€“4), d8 (lv.5â€“9), d10 (lv.10â€“14), d12 (lv.15â€“20). Recipient adds the die to one attack roll, ability check, or saving throw within 10 minutes. Recharge: Short Rest (lv.5+) or Long Rest." },
