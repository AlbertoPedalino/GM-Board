...
registerSubclassSheetActions("Warlock_Archfey", [
  { name: "Steps of the Fey", icon: "", cat: "bonus", uses: "CHA mod / LR", resKey: "archfey_steps", minLevel: 3,
    desc: "Bonus Action: cast Misty Step without expending a spell slot (CHA modifier uses per LR). When you teleport, choose one effect â€” Refreshing Step: regain 1d10 Temporary HP; or Taunting Step: each creature of your choice you can see within 5 ft of your destination makes a WIS save (spell save DC) or has Disadvantage on attack rolls against creatures other than you until the start of your next turn." },
  { name: "Misty Escape", icon: "", cat: "reaction", uses: "Pact Magic slot", minLevel: 6,
    desc: "Reaction when you take damage: expend one Pact Magic slot to cast Misty Step. After teleporting, choose one effect â€” Fey Refuge: have the Invisible condition until start of your next turn or until you attack, deal damage, or cast a spell; or Fey Curse: creatures within 5 ft of your origin or destination must succeed on a WIS save (spell save DC) or take 2d10 Psychic damage." },
