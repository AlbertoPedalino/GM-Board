...
registerSubclassSheetActions("Warlock_Great Old One", [
  ...
  { name: "Create Thrall", icon: "", cat: "action", uses: "Spell slot", minLevel: 14,
    desc: "You can cast Summon Aberration without a spell slot, without expending material components, and without Concentration â€” it lasts for 1 minute. The summoned aberration gains Temporary HP equal to your Warlock level. When you deal damage to a creature under your Hex, the aberration can use its Reaction to move up to its Speed toward the Hexed target and make one attack against it." },
]);
